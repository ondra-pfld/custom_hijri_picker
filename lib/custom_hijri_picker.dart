...
import 'package:custom_hijri_picker/src/hijri_calendar_builders.dart';
...
const double _kDayPickerRowHeight = 64;
...
class _HijriMonthPickerState extends State<HijriMonthPicker> {
  ...
  Widget _buildItems(BuildContext context, int index) {
    ...
    return new HijriDayPicker(
      ...
      weekColorBg: widget.weekColorBg,
...
class _HijriWeekPickerGridDelegate extends SliverGridDelegate {
  const _HijriWeekPickerGridDelegate();

  @override
  SliverGridLayout getLayout(SliverConstraints constraints) {
    const int columnCount = daysPerWeek;
    final double tileWidth = constraints.crossAxisExtent / columnCount;
    final double tileHeight = 32;
    return new SliverGridRegularTileLayout(
      crossAxisCount: columnCount,
      mainAxisStride: tileHeight,
      crossAxisStride: tileWidth,
  ...
  @override
  bool shouldRelayout(_HijriWeekPickerGridDelegate oldDelegate) => false;
}

const _HijriWeekPickerGridDelegate _kWeekPickerGridDelegate =
    const _HijriWeekPickerGridDelegate();
...
class HijriDayPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> labelsWeek = <Widget>[];
    ...
    return new Column(
      children: <Widget>[
        ...
        //     gridDelegate: _kWeekPickerGridDelegate,
        //     childrenDelegate: new SliverChildListDelegate(labelsWeek,
